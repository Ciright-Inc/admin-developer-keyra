...
const PLACEHOLDER_METRICS: DashboardMetric[] = [
  ...
  { id: "total_applications", label: "Total projects", value: 0, icon: "folder_special", format: "number" },
  { id: "applications_pending_approval", label: "Projects pending listing", value: 0, icon: "pending", format: "number", pulse: "warning" },
